				...
				<?php echo $this->Form->create('Variant',array('class'=>'form-signin','type'=>'file','role'=>'form', 'multiple')); ?>
  					...
  					?>
						...
						<div class="form-group">
						  ...
						  <?php echo $this->Form->input('description',array(
							...
							'required' => 'required',
							'autofocus' => 'autofocus',
                            'value'=> $data['Variant']['description']
						  ));
						  ?>
						</div>
                        ...
                        <div class="form-group">
                          ...
                          <?php echo $this->Form->input('how_it_looks',array(
                            ...
                            'required' => 'required',
                            'autofocus' => 'autofocus',
                            'value' => $data['Variant']['how_it_looks']
                          ));
                          ?>
                        </div>
	              ...
	              <!-- /.box-body -->
		            ...
		            <div class="box-footer">
						<?php
							echo $this->Form->input('Edit Variant',array('class'=>'btn btn-primary pull-right','type'=>'submit','label'=>false));
						?>
		            </div>
