            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="box box-primary">
    	            ...
    	            <h3 class="box-title">View Payment Completed orders</h3>
                        ...
                        <tbody class="tbody">
                          ...
                          <?php foreach ($orders as $data): ?>
                            ...
                            <tr style="cursor: pointer;">
                                ...
                                <td>
                                    <?php
                                        echo $this->Html->link($this->Html->tag('i', '',array('class' => 'fa fa-times')),array('controller'=>'orders','action'=>'mark_order/'.$data['Order']['id'].'/-1'),array('class'=>'btn btn-danger btn-circle btn-sm btn-block', 'escape' => false));
                                    ?>
                                </td>
                                <td>
                                    <?php
                                ...
                                <td>
                                    <?php
                                        echo $this->Html->link('Mark as dispatched',array('controller'=>'orders','action'=>'mark_order/'.$data['Order']['id'].'/2'),array('class'=>'btn btn-info btn-circle btn-sm', 'escape' => false));
                                    ?>
                                </td>
