            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="box box-primary">
    	            ...
    	            <h3 class="box-title">View Completed(Dispatched) Orders</h3>
                        ...
                        <tbody class="tbody">
                          ...
                          <?php foreach ($orders as $data): ?>
                            ...
                            <tr style="cursor: pointer;">
                                ...
                                <td>
                                    <?php
                                        echo $this->Html->link($this->Html->tag('i', '',array('class' => 'fa fa-times')),array('controller'=>'orders','action'=>'delete/'.$data['Order']['id']),array('class'=>'btn btn-danger btn-circle btn-sm btn-block', 'escape' => false));
                                    ?>
                                </td>
                                <td>
                                    <?php
